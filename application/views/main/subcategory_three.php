    ...
    <div class="subdirectory">
        ...
        <div class="subdirectory_blogs">
            <div class="subdirectory_blog">
                ...
                <div class="subdirectory_blog_info">
                    <h4>L'Are Liyard Suncity VIP Club</h4>
                    <div class="reserve_blog">
                        <div class="reserve_one_blog" style="border-left:0px solid;">
                            <p >Total rooms</p>
                            <div>12</div>
                        </div>
                        <div class="reserve_one_blog">
                            <p>Occupied</p>
                            <div>7</div>
                        </div>
                        <div class="reserve_one_blog">
                    ...
                    <div class="reserve_blog_click">
                        <button class="open-modal">Book</button>
                    </div>
                </div>
            </div>
            <div class="subdirectory_blog">
        ...
        <div class="content">
            <div class="content_info">
                ...
                <div class="mod_con_right">
                    ...
                    <a href="vip_club/reserve" class="mod_button_a">
