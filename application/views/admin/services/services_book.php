                    ...
                    <div class="card">
                        <div class="card-body">
                            <center class="m-t-30"><img src="<?=$image?>" width="300" class="img-thumbnail"/>
                                ...
                                <button data-id="<?=$row->id?>" data-img="<?=$row->img_name?>" type="button" class="delete_book btn btn-danger">Delete</button>
                            </center>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            <form id="forma_add_uslugi" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <br><br>
                <input id="add_book" class="w3-button w3-indigo" type="submit" value="Добавить" style="float:right;">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <br><br>
                <input id="update_book" class="w3-button w3-indigo" type="submit" value="Изменить" style="float:right;">
            </form>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function(){
        ...
        $('#add_book').on('click',function(){
            ...
            $.ajax({
                method: "POST",
                url: url+"index.php/admin/podcatalog_two/add_book",
                data: vse_polya_add,
                contentType: false,
                processData: false,
            }).done(function(){
...
//редактирование
        ...
        $("#update_book").on('click', function(){
            ...
            $.ajax({
                method: "POST",
                url: url+"index.php/admin/podcatalog_two/update_book",
                data: vse_polya_add,
                contentType: false,
                processData: false,
            }).done(function(){
        ...
        $(".delete_book").on('click', function(){
            ...
            $.ajax({
                method: "POST",
                url: url+"index.php/admin/podcatalog_two/delete_book",
