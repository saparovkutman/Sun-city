...
<?php 
    ...
    echo link_tag('assets/admin/dist/js/waves.js');
    echo link_tag('assets/admin/assets/node_modules/raphael/raphael-min.js');
    echo link_tag('assets/admin/dist/js/sidebarmenu.js');
    echo link_tag('assets/admin/dist/js/custom.min.js');
    echo link_tag('assets/admin/assets/node_modules/morrisjs/morris.min.js');
