                    ...
                    <div class="card-body">
                        <center class="m-t-30">
                            <a href="/admin/podcatalogs<?php echo $category->id ?>">
                                <img src="<?php echo base_url()?>assets/upload/images/cat_one/<?php echo $category->image_name ?>" style="width: 80%; height: 200px;" class="img-thumbnail">
    ...
    <div class="modal_content">
        ...
        <div class="content">
            <form id="forma_add" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_cat_one" class="w3-button w3-indigo" type="submit" value="button">
            </form>
        </div>
    </div>
</div>
