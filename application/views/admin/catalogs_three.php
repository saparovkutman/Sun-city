                    ...
                    <div class="card-body">
                        <center class="m-t-30">
                            <a href="/admin/podcatalogs<?php echo $category->id ?>">
                                <img src="<?php echo base_url()?>assets/upload/images/cat_three/<?php echo $category->image_name ?>" style="width: 80%; height: 200px;" class="img-thumbnail">
    ...
    <div class="modal_content">
        ...
        <div class="content">
            <form id="forma_add" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_cat_three" class="w3-button w3-indigo" type="submit" value="button">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content" data-modalka_id="#modal_edit">
        ...
        <div class="content">
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="update_cat_three" class="w3-button w3-indigo" type="submit" value="button">
            </form>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function(){
        ...
        $('#add_cat_three').on('click',function(){
            ...
            $.ajax({
                method: "POST",
                url: "requestCatThree/insert_cat_three",
                data: vse_polya_add,
                contentType: false,
                processData: false,
            }).done(function(){
        ...
        $("#update_cat_three").on('click', function(){
            ...
            $.ajax({
                method: "POST",
                url: "requestCatThree/update_cat_three",
                data: vse_polya_add,
                contentType: false,
                processData: false,
            }).done(function(){
        ...
        $(".delete_cat").on('click', function(){
            ...
            $.ajax({
                method: "POST",
                url: "requestCatThree/delete_cat_three",
